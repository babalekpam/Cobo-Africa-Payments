  ...
  return (
    <div className="page fade-in">
      ...
      <div className="card-lg" style={{ maxWidth: 720, lineHeight: 1.8, fontSize: 14, color: "var(--text)" }}>
        ...
        <p style={{ marginBottom: 20 }}>By accessing or using the COBO Africa Payments platform ("Service"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.</p>
        ...
        <p style={{ marginBottom: 20 }}>COBO facilitates cross-border payments across Africa. All transactions are subject to applicable fees, daily limits based on your KYC level, and regulatory compliance. Transaction fees are displayed before confirmation.</p>
        ...
        <p style={{ marginBottom: 20 }}>You may not use COBO for money laundering, terrorist financing, fraud, or any illegal activity. We reserve the right to freeze accounts and report suspicious activity to authorities.</p>
        ...
        <p style={{ marginBottom: 20 }}>COBO is provided "as is" without warranties. We are not liable for any indirect, incidental, or consequential damages arising from use of the Service.</p>
        ...
        <p>For questions about these Terms, contact us at <span style={{ color: "var(--gold)", fontWeight: 600 }}>legal@cobo.africa</span></p>
      </div>
