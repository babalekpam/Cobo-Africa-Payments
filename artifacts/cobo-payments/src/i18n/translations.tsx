...
export function LangProvider({ children }: { children: ReactNode }) {
  const [lang, setLangState] = useState(() => localStorage.getItem("cobo_lang") || "en");
  const setLang = (l: string) => {
    localStorage.setItem("cobo_lang", l);
    setLangState(l);
